...
const CreatePost = () => {
    ...
    const handleCreate = async (e) => {
        ...
        if (!desc.trim()) validationErrors.desc = "Description is required"
        if (!file) validationErrors.file = "Image file is required"
        if (cats.length === 0) validationErrors.cats = "At least one category is required"
            ...
            <div className='px-6 md:px-[200px] mt-8'>
                ...
                <form className='w-full flex flex-col space-y-4 md:space-y-8 mt-4'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        {errors.cats && <p className="text-red-500">{errors.cats}</p>}
